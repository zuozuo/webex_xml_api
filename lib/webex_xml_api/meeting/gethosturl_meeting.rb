module WebexXmlApi
  module Meeting
    ##
    # The +GethosturlMeeting+ Class queries WebEx API Service for given
    # session_key (meeting key) and returns a Hash with WebEx host URL
    #
    class GethosturlMeeting
      include WebexXmlApi::Common

      # XML Request Type for the
      # <tt>WebexXmlApi::Meeting::GethosturlMeeting</tt> service
      REQUEST_TYPE =
        'java:com.webex.service.binding.meeting.GethosturlMeeting'.freeze
      ...
      # <tt>WebexXmlApi::Meeting::GethosturlMeeting</tt> instance as understood
      # by the WebEx XML Service.
      #
      def to_xml
        raise WebexXmlApi::NotEnoughArguments,
              'Meeting::GethosturlMeeting' unless valid?
        body_content = {}
